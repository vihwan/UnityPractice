...
public class GunController : MonoBehaviour
{
    ...
    private Vector3 originPos;      // 조준 본래 포지션값
    private RaycastHit hitInfo;     //충돌 정보 받아오는 레이저


    //상태변수
    public static bool isGunAttack = true; //총의 공격이 실행 가능한 상태인가?
    ...
    [SerializeField] private Camera theCam; //정조준 카메라 정보
    [SerializeField] private LayerMask layerMask;
    private CrossHair theCrosshair;
    [SerializeField] private GameObject hitEffect_Prefab; //타격 피격 이펙트
